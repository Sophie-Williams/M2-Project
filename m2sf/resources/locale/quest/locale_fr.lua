...
locale.dungeon = {}
locale.dungeon.time_limit_party = "Un membre du groupe est parti en raison de l'expiration du délai de donjon."
locale.dungeon.time_limit = "Vous êtes parti en raison de la limite de temps du donjon expirée."
locale.dungeon.no_ticket_party = "Au moins un allié ne possède pas de ticket."
locale.dungeon.no_ticket = "Vous êtes parti faute de billet."
locale.dungeon.level_limit_party ="Un membre du parti est parti en raison de la limite de niveau minimum de %dLv."
locale.dungeon.level_limit = "ATTENTION ! Afin d'entrer dans l'Observatoire de[ENTER]Nemere, chaque membre du groupe doit avoir[ENTER]atteint le niveau 100. Les joueurs suivants n'ont[ENTER]PAS encore atteint ce niveau :"
locale.dungeon.leader_can_go = "Seul le chef du groupe peut solliciter le droit[ENTER]d'entrer."
locale.dungeon.enter_yes = "Entrer"
locale.dungeon.enter_no = "Ne pas entrer"
locale.dungeon.leader_can_enter = "Seul le chef du groupe peut solliciter le droit[ENTER]d'entrer. "
locale.dungeon.party_can_enter = "Vous devez être avec votre groupe pour entrer dans ce donjon"
...
locale.snow_dungeon = {}
locale.snow_dungeon.say_1 = "Pénétrer dans l'Observatoire de Nemere"
locale.snow_dungeon.say_2 =  "La durée d'admission pour l'Observatoire de Nemere (ST) est de 1 heure."
locale.snow_dungeon.say_3 = "Vous quittez le donjon pour faute de ticket."
locale.snow_dungeon.say_4 = "Dans quelques secondes, vous serez téléportés dans la salle du trône de Nemere."
locale.snow_dungeon.say_5 = "Observatoire de Nemere "
locale.snow_dungeon.say_6 = "Souhaitez-vous entrer maintenant dans l'Observatoire de Nemere ?"
locale.snow_dungeon.say_7 = "Dans quelques secondes, vous serez téléportés au deuxième étage."
locale.snow_dungeon.say_8 = "Dans quelques secondes, vous serez téléportés au quatrième étage."
locale.snow_dungeon.say_9 = "Dans quelques secondes, vous serez téléportés au cinquième étage."
locale.snow_dungeon.say_10 = "La Metin du froid est apparue !"
locale.snow_dungeon.say_11 = "Dans quelques secondes, vous serez téléportés au troisième étage.."
locale.snow_dungeon.say_12 = "Il s'agit de la mauvaise clé. Trouvez la bonne ! "
locale.snow_dungeon.say_13 = "Terminé ! Ouvrez maintenant le deuxième sceau. "
locale.snow_dungeon.say_14 = "Terminé ! Ouvrez maintenant le troisième sceau."
locale.snow_dungeon.say_15 = "Prenez garde à respecter le bon ordre ! Essayez avec un autre cube."
locale.snow_dungeon.say_16 = "Terminé ! Ouvrez maintenant le quatrième sceau."
locale.snow_dungeon.say_17 = "Terminé ! Ouvrez maintenant le cinquième sceau."
locale.snow_dungeon.say_18 = "Dans quelques secondes, vous serez téléportés au sixième étage."
locale.snow_dungeon.say_19 = "Dans quelques secondes, vous serez téléportés au septième étage."
locale.snow_dungeon.say_20 = "Ses sosies disparaissent."
locale.snow_dungeon.say_21 = "Dans quelques secondes, vous serez téléportés au huitième étage."
locale.snow_dungeon.say_22 = "Dans quelques secondes, vous serez téléportés au neuvième étage."
locale.snow_dungeon.say_23 = "Tuez Nemere, le souverain du gel et de la glace."
locale.snow_dungeon.say_24 = "Dans quelques secondes, vous serez téléportés dehors."
locale.snow_dungeon.say_25 = "Après écoulement du délai, le groupe sera téléporté hors de la forteresse."
locale.snow_dungeon.say_26 = "Le délai d'entrée du château des dragons des neiges est de %dmin restant."
locale.snow_dungeon.say_27 = "Votre temps dans l'Observatoire de Nemere est écoulé.."
locale.snow_dungeon.say_28 = "Temps écoulé. Téléportation dans 10 sec."
locale.snow_dungeon.say_29 = "Temps dans l'Obs. de Nemere écoulé.."
locale.snow_dungeon.say_30 = "Le chef du groupe a disparu. Vous ne pouvez pas continuer."
locale.snow_dungeon.say_31 = "Impossible d'aller plus loin car le chef du parti n'a pas atteint lvl 104.."
locale.snow_dungeon.say_32 = "Impossible d'aller plus loin car le chef du parti n'a pas terminé toutes les quêtes du lvl 103."
locale.snow_dungeon.say_33 = "Êtes-vous prêt à affronter le Souverain algide Nemere ?"
locale.snow_dungeon.say_34 = "Entrer"
locale.snow_dungeon.say_35 = "Ne pas entrer"
locale.snow_dungeon.say_36 = "Salle du trône de Nemere"
locale.snow_dungeon.say_37 = "Battez tout les ennemies!"
locale.snow_dungeon.say_38 = "Certains monstres glacés portent une Clé gelée sur eux. Dérobez-la leur et trouvez la bonne clé. Mais attention, seul un Chamane peut l'utiliser !"
locale.snow_dungeon.say_39 = "Pour affronter Némère, vaincre tous les monstres."
locale.snow_dungeon.say_39_1 = "Tuez tous les ennemis ! Une bénédiction vous conférera des forces pour la deuxième vague d'assaut."
locale.snow_dungeon.say_40 = "Ouvrez les sceaux des Cubes de l'Arctis dans le bon ordre afin de pouvoir accéder à l'étage suivant."
locale.snow_dungeon.say_41 = "Tuez les monstres glaciaux et dérobez-leur les Étoiles du Nord afin d'ouvrir les sceaux !"
locale.snow_dungeon.say_42 = "Tuez tous les monstres glaciaux puis détruisez le Metin du froid. Seuls les Chamanes peuvent lui infliger des dégâts."
locale.snow_dungeon.say_43 = "Trouvez et défaites Szel (ST), le Prince qui règne sur la glace et le froid. Il n'y a qu'avec l'aide du dragon que vous aurez une chance de sortir vainqueur."
locale.snow_dungeon.say_44 = "Triomphez de tous les monstres glaciaux et trouvez la Clé du Cristal de glace. Seuls les Ninjas peuvent l'abandonner. Les Chamanes et les Ninjas peuvent l'utiliser."
locale.snow_dungeon.say_45 = "Détruisez les piliers du Dragon du Nord. Seuls les Ninjas et les Chamanes peuvent lui infliger des dégâts."
locale.snow_dungeon.say_46 = "Tuez Nemere, le souverain du gel et de la glace."
locale.snow_dungeon.say_47 = "Impossible de démarrer le donjon avec les membres du groupe."
locale.snow_dungeon.say_48 = "Tu n'es pas un Chamane !"
locale.snow_dungeon.say_49 = "Tu n'es pas un Chamane et ou un Ninja !"
locale.snow_dungeon.say_50 = " et son groupe ont vaincu Némère !"

locale.npc = {}
locale.npc.open_shop = "Ouvrir un magasin"
