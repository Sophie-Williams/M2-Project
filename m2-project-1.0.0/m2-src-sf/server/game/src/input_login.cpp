...
static void __SendChannelInfo(LPCHARACTER ch)
{
	if (!ch)
		return;
...
const std::map<int32_t, const char*> _SpMapNames
{
	{0, "---"},
	{1, "Zone Yongan"},
	{2, "Vallée de Seungryong"},
	{3, "Zone Jayan"},
	{4, "Jungrang"},
	{5, "Hasung Dong"},
	{6, "Miryang"},
	...
	{72, "Kuahlo Dong 2"},
	{73, "Grotte de l'Exil"},
	{74, "Grotte de l'Exil 2"},
	{75, "Temple du Dragon"},
	{76, "Catacombes du Diable"},
	{77, "Kuahlo Dong 3"},
	{81, "Zone de Cérémonie"},
	{91, "Bataille des Empires : Château"},
	{92, "Metin2 Project"},
	{103, "Terrain de Guerre de Guildes"},
	{105, "Terrain de Guerre de Guildes"},
	{108, "Jungsun Dong"},
	{109, "Sangsun Dong"},
	{110, "Terrain de Guerre de Guildes"},
	{111, "Terrain de Guerre de Guildes"},
	{112, "Arène d'Entraînement"},
	{113, "Evénement OX Contest"},
	{114, "Bataille des Empires"},
	{118, "Bataille des Empires : Terre de Feu"},
	{119, "Bataille des Empires : Terre de Feu"},
	{120, "Bataille des Empires : Terre de Feu"},
	{121, "Bataille des Empires : Terre Glaciaire"},
	{122, "Bataille des Empires : Terre Glaciaire"},
	{123, "Bataille des Empires : Terre Glaciaire"},
	{124, "Bataille des Empires : Terre Glaciaire"},
	{125, "Bataille des Empires : Terre du Désert"},
	{126, "Bataille des Empires : Terre du Désert"},
	{127, "Bataille des Empires : Terre du Désert"},
	{128, "Bataille des Empires : Terre du Désert"},
	{140, "Baie de Néphrite"},
	{141, "Cap du Feu Dragonesque"},
	{142, "Falaise de Gautama"},
	{143, "Montagnes Fulgurantes"},
	{181, "Bataille pour le Château"},
	{182, "Bataille pour le Château"},
	{183, "Bataille pour le Château"},
	{251, "Forteresse du Dragon Rouge"},
	{252, "Observatoire de Nemere"},
};
...
void CInputLogin::Entergame(LPDESC d, const char * data)
{
	...
	else if (ch->GetMapIndex() == 113 || ch->GetMapIndex() == 252 || ch->GetMapIndex() >= 2520000 && ch->GetMapIndex() <= 2529999)
	{
