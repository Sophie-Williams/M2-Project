...
class CGuild
{
	public:
		...
		void		RequestDepositMoney(LPCHARACTER ch, int64_t iGold);
		void		RequestWithdrawMoney(LPCHARACTER ch, int64_t iGold);
		void		RecvMoneyChange(int64_t iGold);
		void		RecvWithdrawMoneyGive(int64_t iChangeGold);
