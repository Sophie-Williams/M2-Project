...
namespace quest
{
	...
	enum
	{
		...
		QUEST_D_PLAYER_EVENT,
		QUEST_D_MONSTER_EVENT,
		...
		QUEST_FISHING_SUCCESS_EVENT,
		QUEST_FISHING_FAILED_EVENT,

		
		QUEST_MINING_SUCCESS_EVENT,
		QUEST_MINING_FAILED_EVENT,

		QUEST_REFINE_SUCCESS_EVENT,
		QUEST_REFINE_FAILED_EVENT,
