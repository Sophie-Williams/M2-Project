...
namespace quest
{
	...
	class NPC
	{
		public:
			...
			bool	OnDPlayer(PC& pc);
			bool	OnDMonster(PC& pc);
			
			bool	OnDies(PC& pc);
			bool	OnDeath(PC& pc);
			bool	OnRespawn(PC& pc);
			
			bool	OnDestroy(PC& pc);
			
			
			
			bool	OnMiningSuccess(PC& pc);
			bool	OnMiningFailed(PC& pc);
			
			bool	OnFishingFailed(PC& pc);
			bool	OnFishingSuccess(PC& pc);
			
			bool	OnRefineSuccess(PC& pc);
			bool	OnRefineFailed(PC& pc);
