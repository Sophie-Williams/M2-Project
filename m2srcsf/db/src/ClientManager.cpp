...
void CClientManager::__SendDropTables(CPeer* peerTarget)
{
	...
	dropPacket.dwCommonDropCount				= (uint32_t)	m_vecCommonDropItemTable.size();
	dropPacket.dwCommonDropTableSize			= (uint32_t)	sizeof(TCommonDropItemTable);

	
	dropPacket.dwDropItemCount					= (uint32_t)	m_vecDropItemTable.size();
	dropPacket.dwDropItemTableSize				= (uint32_t)	sizeof(TDropItemTable);
	
	
	dropPacket.dwMobDropItemKillGroupCount		= (uint32_t)	m_vecMobDropItemGroupKill.size();
	dropPacket.dwMobDropItemKillGroupTableSize	= (uint32_t)	sizeof(TMobDropItemGroupKill);

	dropPacket.dwMobDropItemKillCount			= (uint32_t)	m_vecMobDropItemKill.size();
	dropPacket.dwMobDropItemKillTableSize		= (uint32_t)	sizeof(TMobDropItemKill);

	
	dropPacket.dwMobDropItemLevelGroupCount		= (uint32_t)	m_vecMobDropItemGroupLevel.size();
	dropPacket.dwMobDropItemLevelGroupTableSize	= (uint32_t)	sizeof(TMobDropItemGroupLevel);

	dropPacket.dwMobDropItemLevelCount			= (uint32_t)	m_vecMobDropItemLevel.size();
	dropPacket.dwMobDropItemLevelTableSize		= (uint32_t)	sizeof(TMobDropItemLevel);
...
bool CClientManager::InitializeLocalization() 
{
	...
	for (int32_t n = 0; (row = mysql_fetch_row(pMsg->Get()->pSQLResult)) != NULL; ++n)
	{
		...
		strlcpy(M2Locale.szValue, row[col++], sizeof(M2Locale.szValue));
		strlcpy(M2Locale.szKey, row[col++], sizeof(M2Locale.szKey));

		
		if (strcmp(M2Locale.szKey, "LOCALE") == 0)
		{
			if (strcmp(M2Locale.szValue, "cibn") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);

				if (g_stLocale != M2Locale.szValue)
					sys_log(0, "Changed g_stLocale %s to %s", g_stLocale.c_str(), "gb2312");

				g_stLocale = "gb2312";		
				g_stLocaleNameColumn = "gb2312name";
				g_stCountry = M2Locale.szValue;
			}
			else if (strcmp(M2Locale.szValue, "ymir") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "japan") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "english") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "germany") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "france") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "italy") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "spain") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "uk") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "turkey") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "poland") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "portugal") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "hongkong") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "newcibn") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "korea") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "canada") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "brazil") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "greek") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "russia") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "denmark") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "bulgaria") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "croatia") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "mexico") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "arabia") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "czech") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "hungary") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "romania") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "netherlands") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "singapore") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "vietnam") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "thailand") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "usa") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "we_korea") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			else if (strcmp(M2Locale.szValue, "taiwan") == 0)
			{
				sys_log(0, "locale[LOCALE] = %s", M2Locale.szValue);
			...
			{
				sys_err("locale[LOCALE] = UNKNOWN(%s)", M2Locale.szValue);
				exit(0);
			}

			CDBManager::instance().SetLocale(g_stLocale.c_str());
		}
		else if (strcmp(M2Locale.szKey, "DB_NAME_COLUMN") == 0)
		{
			sys_log(0, "locale[DB_NAME_COLUMN] = %s", M2Locale.szValue);
			g_stLocaleNameColumn = M2Locale.szValue;
		}
		else
		{
			sys_log(0, "locale[UNKNOWN_KEY(%s)] = %s", M2Locale.szKey, M2Locale.szValue);
		}
		m_vec_Locale.push_back(M2Locale);
	}	
