...
enum
{
	...
	HEADER_GD_MOB_DROP_TABLE_REQUEST_RELOAD				= 141, 
#endif
...
#ifdef ENABLE_DROP_FROM_TABLE
	HEADER_DG_MOB_DROP_TABLE_LOAD = 182,
#endif
...
typedef struct SItemTable : public SEntityTable
{
	...
	int64_t        alValues[ITEM_VALUES_MAX_NUM];
	int32_t	alSockets[ITEM_SOCKET_MAX_NUM];
...
typedef struct
{
	...
	uint32_t	dwCommonDropCount;
	uint32_t	dwCommonDropTableSize;

	
	uint32_t	dwDropItemCount;
	uint32_t	dwDropItemTableSize;

	
	uint32_t	dwMobDropItemKillGroupCount;
	uint32_t	dwMobDropItemKillGroupTableSize;

	uint32_t	dwMobDropItemKillCount;
	uint32_t	dwMobDropItemKillTableSize;

	
	uint32_t	dwMobDropItemLevelGroupCount;
	uint32_t	dwMobDropItemLevelGroupTableSize;

	uint32_t	dwMobDropItemLevelCount;
	uint32_t	dwMobDropItemLevelTableSize;
} TPacketDGDropTables;
