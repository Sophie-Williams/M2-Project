...
const char* three_arguments(const char* argument, char* first_arg, uint32_t first_size, char* second_arg, uint32_t second_size, char* third_arg, uint32_t third_size)
{
	return (one_argument(one_argument(one_argument(argument, first_arg, first_size), second_arg, second_size), third_arg, third_size));
}

const char* four_arguments(const char* argument, char* first_arg, uint32_t first_size, char* second_arg, uint32_t second_size, char* third_arg, uint32_t third_size, char* four_arg, uint32_t four_size)
{
...
const char* six_arguments(const char* argument, char* first_arg, uint32_t first_size, char* second_arg, uint32_t second_size, char* third_arg, uint32_t third_size, char* four_arg, uint32_t four_size, char* five_arg, uint32_t five_size, char* six_arg, uint32_t six_size)
{
