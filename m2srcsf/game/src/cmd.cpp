...
#ifdef ENABLE_NEW_PET_SYSTEM_WAIT
ACMD(do_Pet_Info);
#endif
...
struct command_info cmd_info[] =
{
	...
	{ "tp",			do_tp,		0,			POS_DEAD,	GM_LOW_WIZARD	},
	...
	{ "miaw",		do_miaw,		0,			POS_DEAD,	GM_IMPLEMENTOR	},
...
#ifdef ENABLE_NEW_PET_SYSTEM_FEED
	{ "feedpetitem",	do_feedpetitem,		0,	POS_DEAD,	GM_PLAYER },
#endif
