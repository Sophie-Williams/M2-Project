...
void CPartyManager::P2PLogin(uint32_t pid, const char* name, uint8_t channel, int32_t mapidx)
#else
...
#ifdef BL_PARTY_UPDATE
void CParty::UpdateOnlineState(uint32_t dwPID, const char* name, uint8_t channel, int32_t mapidx)
#else
