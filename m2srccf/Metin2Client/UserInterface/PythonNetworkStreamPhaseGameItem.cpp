...
bool CPythonNetworkStream::SortInven(uint8_t option)
{
	if (!__CanActMainInstance())
		return true;
...
//bool CPythonNetworkStream::SendItemDropPacket(TItemPos pos, DWORD elk) <--- AVANT LONG LONG
//bool CPythonNetworkStream::SendItemDropPacket(TItemPos pos, long long elk) <--- LONG LONG DEBRIDAGE yang

#ifdef ENABLE_CHEQUE_SYSTEM
bool CPythonNetworkStream::SendItemDropPacket(TItemPos pos, long long elk, long cheque)
#else
bool CPythonNetworkStream::SendItemDropPacket(TItemPos pos, long long elk)
#endif
{
	if (!__CanActMainInstance())
		return true;
...
//bool CPythonNetworkStream::SendItemDropPacketNew(TItemPos pos, long long elk, DWORD count)

#ifdef ENABLE_CHEQUE_SYSTEM
bool CPythonNetworkStream::SendItemDropPacketNew(TItemPos pos, long long elk, DWORD count, long cheque)
#else
bool CPythonNetworkStream::SendItemDropPacketNew(TItemPos pos, long long elk, DWORD count)
#endif
{
