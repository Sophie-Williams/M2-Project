...
class CPythonNetworkStream : public CNetworkStream, public CSingleton<CPythonNetworkStream>
{
	...
	public:
		...
		//OLD//bool SendItemDropPacket(TItemPos pos, DWORD elk);
		//bool SendItemDropPacket(TItemPos pos, long long elk);
		//OLD//bool SendItemDropPacketNew(TItemPos pos, DWORD elk, DWORD count);
		//bool SendItemDropPacketNew(TItemPos pos, long long elk, DWORD count);


#ifdef ENABLE_CHEQUE_SYSTEM
		bool SendItemDropPacket(TItemPos pos, long long elk, long cheque);
		bool SendItemDropPacketNew(TItemPos pos, long long elk, DWORD count, long cheque);
#else
		bool SendItemDropPacket(TItemPos pos, long long elk);
		bool SendItemDropPacketNew(TItemPos pos, long long elk, DWORD count);
#endif
...
#ifdef ENABLE_CHEQUE_SYSTEM
		bool SendExchangeChequeAddPacket(long cheque); //DWORD elk ???
#endif
