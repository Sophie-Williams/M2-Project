...
void CPythonExchange::SetChequeToTarget(long cheque)
{
	m_victim.cheque = cheque;
}

void CPythonExchange::SetChequeToSelf(long cheque)
{
	m_self.cheque = cheque;
}

long CPythonExchange::GetChequeFromTarget() const
{
	return m_victim.cheque;
}

long CPythonExchange::GetChequeFromSelf() const
{
