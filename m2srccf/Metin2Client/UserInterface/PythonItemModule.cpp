...
void initItem()
{
	...
	PyModule_AddIntConstant(poModule, "USE_SET_SOULBIND",			CItemData::USE_SET_SOULBIND);
	PyModule_AddIntConstant(poModule, "USE_DEL_SOULBIND",			CItemData::USE_DEL_SOULBIND);
