	...
	(
		{
			...
			(
				# Pet Hatching Window Title
				{
					...
					"children" :
					(
						{ "name":"TitleName", "type":"text", "x":0, "y":0, "text":uiScriptLocale.PET_KULUCKA, "all_align":"center" },
					),
				},
				...
				## Pet Hatching Money
				{
					...
					"children" :
					(
						{"name":"HatchingMoney", "type":"text", "x":0, "y":0, "text": uiScriptLocale.PET_FIYAT, "r":1.0, "g":1.0, "b":1.0, "a":1.0, "all_align" : "center"},
					),
				},
				...
				## Pet Hatching Button
				{
					...
					"text" : uiScriptLocale.PET_YUMURTADAN_CIK,
				...
				{ 
					...
					"children" :
					(
						{"name":"PetNamingTitle", "type":"text", "x":0, "y":0, "text":uiScriptLocale.PET_ISMI, "all_align" : "center"},
					),
				},
			),				
		},
