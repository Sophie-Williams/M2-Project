...
PET_UI_ROOT2 = "d:/ymir work/ui/buton/"
				...
				## Page Area
				{
					...
					[
						...
						{ 
							...
							"children" :
							(
								{"name":"SpTitle", "type":"text", "x":0, "y":0, "text": uiScriptLocale.PET_SYSTEM_PM, "color":GOLD_COLOR, "all_align" : "center"},
							),
						},
						## SP Value
						{ 
	...
	## Click DETERMINE Button(DETERMINE)
		{
			...
			"height" : 26,
					...
					"default_image" : PET_UI_ROOT2 + "new_pet_button_1.tga",
					"over_image" : PET_UI_ROOT2 + "new_pet_button_2.tga",
					"down_image" : PET_UI_ROOT2 + "new_pet_button_3.tga",
		},]
