...
CAMERA_MAX_DISTANCE_LONG = 5000.0
...
def IS_AUTO_POTION_SP(itemVnum):
	if 72727 <= itemVnum and 72730 >= itemVnum:
		...
		return 1
	elif itemVnum == 55701 or itemVnum == 55702 or itemVnum == 55703 or itemVnum == 55704 or itemVnum == 55705 or itemVnum == 55706 or itemVnum == 55707 or itemVnum == 55708 or itemVnum == 55709 or itemVnum == 55710 or itemVnum == 55711:
		return 1
...
def IS_PET(itemVnum):
	if itemVnum >= 55701 and itemVnum <= 55711:
		return 1
	elif itemVnum >= 70500 and itemVnum <= 70509:
		return 1
