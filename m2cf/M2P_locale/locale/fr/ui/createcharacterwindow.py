					...
					(
						{
							...
							"x" : X_GAP + 4,
							"y" : 10,
							"default_image" : ROOT_PATH + "public_create_button/warrior_default.sub",
							"over_image" : ROOT_PATH + "public_create_button/warrior_over.sub",
							"down_image" : ROOT_PATH + "public_create_button/warrior_down.sub",
							"children" :
							(
								{ 
						...
						},
						{
							...
							"x" : X_GAP + 4,
							"y" : 10 + SELECT_BTN_GAP,
							"default_image" : ROOT_PATH + "public_create_button/assassin_default.sub",
							"over_image" : ROOT_PATH + "public_create_button/assassin_over.sub",
							"down_image" : ROOT_PATH + "public_create_button/assassin_down.sub",
							"children" :
							(
								{ 
						...
						},
						{
							...
							"default_image" : ROOT_PATH + "public_create_button/sura_default.sub",
							"over_image" : ROOT_PATH + "public_create_button/sura_over.sub",
							"down_image" : ROOT_PATH + "public_create_button/sura_down.sub",
							"children" :
							(
								{ 
						...
						},
						{
							...
							"default_image" : ROOT_PATH + "public_create_button/shaman_default.sub",
							"over_image" : ROOT_PATH + "public_create_button/shaman_over.sub",
							"down_image" : ROOT_PATH + "public_create_button/shaman_down.sub",
							"children" :
							(
								{ 
						...
						#	"default_image" : ROOT_PATH + "public_create_button/wolf_default.sub",
						#	"over_image" : ROOT_PATH + "public_create_button/wolf_over.sub",
						#	"down_image" : ROOT_PATH + "public_create_button/wolf_down.sub",
						#	"children" :
						#	(
						#		{
